...
#line 3 "..\\..\\SYSTEM\\SRC\\rs485.c"
#line 1 "..\\..\\SYSTEM\\INC\\rs485.h"
...
static volatile int rs485_recv_ch = (-1);   
static volatile int rs485_recv_flag = 0;   
...
void rs485_init(uint32_t baudrate)
{
	...
	RCC_AHB1PeriphClockCmd(((uint32_t)0x00000001) | ((uint32_t)0x00000040), ENABLE);
	...
	USART_ClearITPendingBit(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), ((uint16_t)0x0525) | ((uint16_t)0x0727));   
	...
	do { *((volatile unsigned int *) ((((((uint32_t)0x40000000) + 0x00020000) + 0x1800) & 0xF0000000) + 0x02000000 + (((((((uint32_t)0x40000000) + 0x00020000) + 0x1800) & 0x000FFFFF) + 0x14) << 5) + ((8) << 2))) = 0; } while (0);
}
...
int rs485_putchar(int c)
{
	...
	do { *((volatile unsigned int *) ((((((uint32_t)0x40000000) + 0x00020000) + 0x1800) & 0xF0000000) + 0x02000000 + (((((((uint32_t)0x40000000) + 0x00020000) + 0x1800) & 0x000FFFFF) + 0x14) << 5) + ((8) << 2))) = 1; } while (0);
	
	
	while (RESET == USART_GetFlagStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), ((uint16_t)0x0080)));
	
	
	USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), c);
	
	
	while (RESET == USART_GetFlagStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), ((uint16_t)0x0040)));
...
void USART2_IRQHandler(void)
{
	...
	if (SET == USART_GetITStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), ((uint16_t)0x0525)))  
	{
		rs485_recv_ch = USART_ReceiveData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)));
		rs485_recv_flag = 1;
