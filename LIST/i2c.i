...
#line 5 "..\\..\\SYSTEM\\SRC\\i2c.c"
#line 1 "..\\..\\SYSTEM\\INC\\i2c.h"



#line 5 "..\\..\\SYSTEM\\INC\\i2c.h"

#line 12 "..\\..\\SYSTEM\\INC\\i2c.h"
...
void i2c1_init(void)
{
	...
	I2C_InitStruct.I2C_DutyCycle           = ((uint16_t)0x4000);
...
int i2c1_24c02_page_write(uint8_t *data, uint32_t size, uint8_t addr)
{
	...
	timeout = 0xFFFFFUL;
	while (timeout-- && (SET == I2C_GetFlagStatus(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), ((uint32_t)0x00020000))));
	if (0 == timeout)
	{
		return -1;
	}
	...
	timeout = 0xFFFFFUL;
	while (timeout-- && (ERROR == I2C_CheckEvent(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), ((uint32_t)0x00030001))));
	if (0 == timeout)
	{
		return -1;
	}
	...
	I2C_Send7bitAddress(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), 0xA0, ((uint8_t)0x00));
	
	timeout = 0xFFFFFUL;
	while (timeout-- && (ERROR == I2C_CheckEvent(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), ((uint32_t)0x00070082))));
	if (0 == timeout)
	{
		return -1;
	}
	...
	timeout = 0xFFFFFUL;
	while (timeout-- && (ERROR == I2C_CheckEvent(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), ((uint32_t)0x00070080))));
	if (0 == timeout)
	{
		return -1;
	}
	...
	I2C_SendData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), addr);
	...
	{
		I2C_SendData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), data[count]);
	...
	timeout = 0xFFFFFUL;
	while (timeout-- && (ERROR == I2C_CheckEvent(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), ((uint32_t)0x00070084))));
	if (0 == timeout)
	{
		return count;
	}
	...
	timeout = 0xFFFFFUL;
	while (timeout-- && (((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400))->CR1 & ((uint16_t)0x0200)));
	if (0 == timeout)
	{
		return count;
	}
...
int i2c1_24c02_ReadBuffer(uint8_t *buf, uint8_t addr, uint8_t size)
{
  ...
  while(!I2C_CheckEvent(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), ((uint32_t)0x00030001)))
  {
	...
	I2C_Send7bitAddress(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), 0xA0, ((uint8_t)0x01)); 
	...
	for (i = 0; i < size - 1; i++)
	{
		...
		buf[i] = I2C_ReceiveData(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)));
	}
