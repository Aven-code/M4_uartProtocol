...
#line 41 "main.c"
#line 1 "E:\\Kile\\ARM\\ARMCC\\Bin\\..\\include\\string.h"
...
#line 38 "E:\\Kile\\ARM\\ARMCC\\Bin\\..\\include\\string.h"
    ...
    typedef unsigned int size_t;    
#line 54 "E:\\Kile\\ARM\\ARMCC\\Bin\\..\\include\\string.h"
...
#line 193 "E:\\Kile\\ARM\\ARMCC\\Bin\\..\\include\\string.h"
...
#line 209 "E:\\Kile\\ARM\\ARMCC\\Bin\\..\\include\\string.h"
...
#line 232 "E:\\Kile\\ARM\\ARMCC\\Bin\\..\\include\\string.h"
...
#line 247 "E:\\Kile\\ARM\\ARMCC\\Bin\\..\\include\\string.h"
...
#line 270 "E:\\Kile\\ARM\\ARMCC\\Bin\\..\\include\\string.h"
...
#line 502 "E:\\Kile\\ARM\\ARMCC\\Bin\\..\\include\\string.h"
...
int main(void)
{
  ...
  RCC_GetClocksFreq(&RCC_Clocks);
	...
	systick_init(((uint32_t)0xFFFFFFFB));   
  ...
  while (1)
  {
		char str[20] = "Hello world", *s = str;
		int cnt = 0, total = strlen(str);
		uint8_t addr = 0;

		printf("total = %d\r\n", total);
		while (1)
		{
			cnt = i2c1_24c02_page_write((uint8_t *) s, strlen(s), addr);
			...
			else
			{
				...
				if (0 == total)
				{
					...
					cnt = i2c1_24c02_ReadBuffer((uint8_t *) str2, 0, 11);
					printf("读取了 %d 个字节：%s\r\n", cnt, str2);
					while (1);
				}
			}
