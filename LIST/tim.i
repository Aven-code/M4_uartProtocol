...
#line 2 "..\\..\\SYSTEM\\SRC\\tim.c"
#line 1 "..\\..\\SYSTEM\\INC\\tim.h"



#line 5 "..\\..\\SYSTEM\\INC\\tim.h"
...
void tim2_init(uint16_t period, uint16_t prescaler)
{
	...
	TIM_TimeBaseInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), &TIM_TimeBaseInitStruct);
...
{
	if (SET == TIM_GetITStatus(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((uint16_t)0x0001)))
	{
		flag = 1;
...
void tim14_ch1_led0_init(uint16_t period, uint16_t prescaler, uint16_t compare)
{
	...
	GPIO_PinAFConfig(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400)), ((uint8_t)0x09), ((uint8_t)0x09));
	...
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1400)), &GPIO_InitStruct);
	...
	TIM_TimeBaseInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x2000)), &TIM_TimeBaseInitStruct);
	...
	TIM_OCInitStruct.TIM_OCPolarity = ((uint16_t)0x0002);       
	TIM_OCInitStruct.TIM_OutputState = ((uint16_t)0x0001);  
	TIM_OCInitStruct.TIM_Pulse = compare;                       
	TIM_OC1Init(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x2000)), &TIM_OCInitStruct);
	...
	TIM_ClearITPendingBit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x2000)), ((uint16_t)0x0001));
	
	
	TIM_ITConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x2000)), ((uint16_t)0x0001), ENABLE);
}
...
void TIM8_TRG_COM_TIM14_IRQHandler(void)
{
	...
	if (TIM_GetITStatus(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x2000)), ((uint16_t)0x0001)) == SET)
	{
		led0_pwm_cnt++;
