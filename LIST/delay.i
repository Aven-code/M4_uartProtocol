...
void systick_init(uint32_t systick_clksrc)
{
	...
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD  = 0UL;
  ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL   = 0UL;
	if (systick_clksrc == ((uint32_t)0x00000004))
	{
		((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL  = (1UL << 2);   
	...
	else
	{
		...
		fac_us = RCC_Clocks.HCLK_Frequency / 8000000;  
	}
}
...
{
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = nus * fac_us - 1;
  ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL  = 0UL;
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL |= (1UL );
	while ((((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL & (1UL << 16)) != (1UL << 16));
	((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL &= ~(1UL );
}
