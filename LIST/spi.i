...
#line 3 "..\\..\\SYSTEM\\SRC\\spi.c"
#line 1 "..\\..\\SYSTEM\\INC\\spi.h"
...
void spi1_init(uint16_t baudrate)
{
	...
	RCC_AHB1PeriphClockCmd(((uint32_t)0x00000002) | ((uint32_t)0x00000040), ENABLE);
	...
	GPIO_InitStruct.GPIO_Pin = ((uint16_t)0x0008) | ((uint16_t)0x0010) | ((uint16_t)0x0020);
	...
	GPIO_InitStruct.GPIO_Pin = ((uint16_t)0x4000);
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), &GPIO_InitStruct);
	
	
	GPIO_InitStruct.GPIO_Mode = GPIO_Mode_OUT;
	GPIO_InitStruct.GPIO_Pin = ((uint16_t)0x0080);
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1800)), &GPIO_InitStruct);
	...
	SPI_Init(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)), &SPI_InitStruct);
	
	
	SPI_Cmd(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)), ENABLE);
	
	
	do { *((volatile unsigned int *) ((((((uint32_t)0x40000000) + 0x00020000) + 0x0400) & 0xF0000000) + 0x02000000 + (((((((uint32_t)0x40000000) + 0x00020000) + 0x0400) & 0x000FFFFF) + 0x14) << 5) + ((14) << 2))) = 1; } while (0);
	do { *((volatile unsigned int *) ((((((uint32_t)0x40000000) + 0x00020000) + 0x1800) & 0xF0000000) + 0x02000000 + (((((((uint32_t)0x40000000) + 0x00020000) + 0x1800) & 0x000FFFFF) + 0x14) << 5) + ((7) << 2))) = 1; } while (0);
}
...
uint8_t spi1_w25q128_read_write_byte(uint8_t data)
{
	...
	while (RESET == SPI_I2S_GetFlagStatus(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)), ((uint16_t)0x0002)));
	SPI_I2S_SendData(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)), data);
	
	while (RESET == SPI_I2S_GetFlagStatus(((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)), ((uint16_t)0x0001)));
...
uint16_t spi1_w25q128_read_id(void)
{
	...
	do { *((volatile unsigned int *) ((((((uint32_t)0x40000000) + 0x00020000) + 0x0400) & 0xF0000000) + 0x02000000 + (((((((uint32_t)0x40000000) + 0x00020000) + 0x0400) & 0x000FFFFF) + 0x14) << 5) + ((14) << 2))) = 0; } while (0);
	
	
	spi1_w25q128_read_write_byte(0x90);
	...
	id = spi1_w25q128_read_write_byte(0xFF) << 8;
	
	id |= spi1_w25q128_read_write_byte(0xFF) & 0xFF;
...
uint8_t spi1_w25q128_read_sr1(void)
{
	...
	spi1_w25q128_read_write_byte(0x05);
	sr1 = spi1_w25q128_read_write_byte(0xFF);
...
void spi1_w25q128_write_enable(void)
{
	...
	spi1_w25q128_read_write_byte(0x06);
...
void spi1_w25q128_write_disable(void)
{
	...
	spi1_w25q128_read_write_byte(0x04);
