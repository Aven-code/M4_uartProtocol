...
void led_init(void)
{
	...
	RCC_AHB1PeriphClockCmd(((uint32_t)0x00000010) 
		| ((uint32_t)0x00000020),	ENABLE);
	
	
	GPIO_InitStruct.GPIO_Mode = GPIO_Mode_OUT;    
	GPIO_InitStruct.GPIO_OType = GPIO_OType_PP;   
	GPIO_InitStruct.GPIO_Pin = ((uint16_t)0x2000) | ((uint16_t)0x4000);
