...
static volatile uint8_t key_value = 0;   
...
void key_init(void)
{
	...
	GPIO_InitStruct.GPIO_Pin = ((uint16_t)0x0004) | ((uint16_t)0x0008) | ((uint16_t)0x0010);
	...
	RCC_APB2PeriphClockCmd(((uint32_t)0x00008000), ENABLE);
	
	
	SYSCFG_EXTILineConfig(((uint8_t)0x00), ((uint8_t)0x00));
	SYSCFG_EXTILineConfig(((uint8_t)0x04), ((uint8_t)0x02));
	SYSCFG_EXTILineConfig(((uint8_t)0x04), ((uint8_t)0x03));
	SYSCFG_EXTILineConfig(((uint8_t)0x04), ((uint8_t)0x04));
	
	RCC_APB2PeriphClockCmd(((uint32_t)0x00004000), DISABLE);
	
	EXTI_InitStruct.EXTI_Line = ((uint32_t)0x00001) | ((uint32_t)0x00004) | ((uint32_t)0x00008) | ((uint32_t)0x00010);
...
void EXTI0_IRQHandler(void)
{
	...
	if (EXTI_GetITStatus(((uint32_t)0x00001)))   
	{
